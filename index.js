...
mongoose
  ...
  // })
  // .then((newRecipe) => {
  //   console.log('Se ha registrado esta receta:', newRecipe.title)
  // })
  .then(() => {
  ...
  .then((newRecipes) => {
    ...
    newRecipes.forEach(elm => console.log('Se han registrado las siguientes recetas:', elm.title))
  })
  .then(() => {
    return Recipe.findOneAndUpdate({ "title": "Rigatoni alla Genovese" }, { duration: 100 }, { new: true })
  })
  .then((updatedRecipe) => {
    console.log(`Se ha actualizado la duración a:`, updatedRecipe.duration)
  })
  .then(() => {
