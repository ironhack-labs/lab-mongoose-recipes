...
mongoose
  ...
  function crearReseta(){
    const primerPlato = new Recipe({
  ...
  //Borrar elemento
  // Recipe.deleteOne({title:"Carrot Cake"}).then(console.log("Se eliminó de manera exitosa :D")).catch(console.log)