...
mongoose
  ...
  .then(newRecipes => {
    newRecipes.forEach(newRecipe => console.log(newRecipe.title))
  })
  ...
  .then(upadtedRecipe => console.log('Update succeded! The recipe updated is:', upadtedRecipe))

  // ITERATION 5
  .then(() => {
    return Recipe.deleteOne({title: "Carrot Cake"})
  })
  .then(deletedRecipe => console.log('Delete succeded! The recipe deleted is:', deletedRecipe))
