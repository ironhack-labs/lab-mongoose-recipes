...
// Some extras setting to debug console errors
...
const recipeSchema = new Schema ({
	...
	images		: { type: String, default: 'https://images.media-allrecipes.com/images/75131.jpg' },
	duration	: { type: Number, min: 0 },
	creator 	: String,
	created		: { type: Date, default: Date.now }
});

// Compile Schema recipe to model
...
//  Insert Many recipes referenced by Recipe Model
Recipe.collection.insert(recipes, function (err,docs){
	if (err){ 
          return console.error(err);
      } else {
        console.log("Datas inserted to Collection");
    }
});

// Update Rigatoni alla Genovese recipe
var successUpdateCallback = "Data update successfully";
var errorUpdateCallback = "An error occured during the update";

Recipe.findByIdAndUpdate("5c9e2b8b989178025a386fab", { duration: 100 })
  .then(console.log(successUpdateCallback))
  .catch(console.log(errorUpdateCallback));

// Remove Carrot Cake data
var successRemoveCallback = "Data removed successfully";
var errorRemoveCallback = "An error occured during the removal";

Recipe.deleteOne({ title: "Carrot Cake"})
  .then(console.log(successRemoveCallback))
  .catch(console.log(errorRemoveCallback));
