...
mongoose
  ...
  .then(() => {
    ...
    //   Recipe
    //     .create([{
    //       title: "Euskal Glazed Chicken Thighs",
    //       level: "Amateur Chef",
    //       ingredients: [
    ...
    //     },
    //     ])
    //     .then(theNewRecipe => console.log('La nueva receta es:', theNewRecipe))        // <== retorno
    ...
    Recipe
      ...
      .then(theNewRecipe => theNewRecipe.forEach(elm => console.log(elm.title)))
    // console.log('Las nuevas recetas son:', theNewRecipe.title)
  ...
  .then(() => {
    ...
    Recipe.deleteOne({ title: 'Carrot cake' }, function (err, result) {
      if (err) {
