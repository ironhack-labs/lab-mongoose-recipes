...
mongoose.connect('mongodb://localhost/recipeApp')
  .then(() => {
    ...
    /** INSERT A RECIPE */
    Recipe.create({
      title: `Lu's Tacos al pastor`,
      level: 'UltraPro Chef',
      ingredients: ['10 Corn tortillas', '200ml Salsa verde', '500g Pork sirloin', '4 limes', '1 large onion', '1/2 cup of orange juice', '2tbsp cumin', 'Kosher salt to taste'],
      cousine: 'Mexican',
      dishTpe: 'Dish',
      image: 'https://keviniscooking.com/wp-content/uploads/2017/04/Authentic-Tacos-Al-Pastor6-2.jpg',
      duration: 240,
      creator: 'Ludwig'
    })
