...
mongoose
  ...
  .then(() => {
    // Iteration 2
    // Recipe.create({ title: 'Simple Pancakes', level: 'Easy Peasy', ingredients: ['100g plain flour', '2 large eggs', '300ml milk', '1 tbsp vegetable oil'], cuisine: 'American', dishType: 'breakfast', duration: 30, creator: "Cassie Best"})
  ...
  // Iteration 5
  // Recipe.deleteOne({title: 'Carrot Cake'}).then(recipe => {console.log("deleted");
  //   });
  // })    
