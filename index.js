...
Recipe.create({
  ...
  image:
    "https://img.chefkoch-cdn.de/rezepte/745721177147257/bilder/668335/crop-600x400/lasagne.jpg",
  duration: 60,
  ...
  .then((theNewsRecipesInsert) => {
    theNewsRecipesInsert.forEach((elm) =>
      console.log("The news recipes are:", elm.title)
    );
