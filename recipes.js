...
Recipe.insertMany(data)
  .then((recipe) => { console.log('The recipe is saved and its title is: ', recipe[0].title) })
  .catch((err) => { console.log('An error happened:', err) });


  //timeout function for iteration 4
  //new timeout function for iteration 5
  //connection.close() or something like that for iteration 6
