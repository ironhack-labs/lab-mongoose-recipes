...
mongoose
  ...
  .then(self => {
    console.log(`You are connected to this: "${self.connection.name}"`);
  ...
  /////////////////////// have to comment it out otherwise it's going to find duplicates //////////////
...
//Recipe.findOneAndUpdate({duration: 220}, {duration: 100}, {new: true}).then(recipe => console.log(recipe))
