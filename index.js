...
//Edit the Genovese recipe:
Recipe.findOneAndUpdate({ title: "Rigatoni alla Genovese"}, {duration: 100}).then(()=>{console.log("Duration has been updated!")})

//Delete Carrot Cake:
Recipe.deleteOne( {title: 'Carrot Cake'}).then(()=>{console.log("Carrot Cake has been removed from collection.")})